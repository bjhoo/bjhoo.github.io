...
portfolio.run(["$rootScope","$location","$window","$timeout",
               ...
               function(a){
                 a.org=[
                   {id:1,img:"images/ignore/MS_HMILabs_snip.png",header:"HMI Delivery",description:"During the 'year I'm not doing powerpoint' I presented a Microsoft Paint presentation on the internal process and expected outcomes of the Human-Machine Interface Labs group.",html:'<a href="documents/MS_HMILabs.png" class="btn btn-block"><i class="fa fa-external-link-square"></i> PNG</a>'},
                   {id:2,img:"images/ignore/Org_Design_Ops.png",header:"Mult-team Operations",description:"Establishing enterprise initiative focused on how we deliver a unified experience with multiple teams focused on journeys and outcomes. (Some or all content altered to protect confidentiality).",html:'<a href="documents/Org_Design_Ops.pdf" class="btn btn-block"><i class="fa fa-external-link-square"></i> PDF</a>'}
                 ],
                 a.ux=[
